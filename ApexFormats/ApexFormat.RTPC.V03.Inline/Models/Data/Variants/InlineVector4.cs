...
public class InlineVector4 : InlineCountable
{
    public uint NameHash { get; set; }
    public string Name { get; set; } = string.Empty;
    public static EVariantType VariantType => EVariantType.Vector4;
    protected float[] Values { get; set; } = Array.Empty<float>();
    
    public override uint Count { get; set; } = 4;

    public InlineVector4() {}
    public InlineVector4(InlinePropertyHeader header)
    {
